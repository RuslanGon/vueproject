...
<header class="flex justify-between border-b border-slate-300 px-10 py-8">
  ...
  <ul class="flex items-center gap-10 text-slate-500">
    <li class="flex items-center gap-3"><img src="/cart.svg" alt="cart"><span>1205 руб</span></li>
    <li class="flex items-center gap-3"><img src="/heart.svg" alt="heart"><span>Закладки</span></li>
    <li class="flex items-center gap-3"><img src="/profile.svg" alt="cart"><span>Профиль</span></li>
  </ul>
</header>
</div>
</template>
