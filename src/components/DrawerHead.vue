<template>
     <div class="flex items-center gap-5 mb-8">
        <svg  width="20" height="20" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="stroke-black opacity-30 cursor-pointer rotate-180 hover:opacity-100 transition hover:-translate-x-1">
